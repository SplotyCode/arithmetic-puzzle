...
public class MadMax implements HexBinary {
    ...
    public static void main(String[] args) {
        System.out.println(HexBinary.toHexString(solve(HexBinary.extractHex("1A02B6B50D7489D7708A678593036FA265F2925B21C28B4724DD822038E3B4804192322F230AB7AF7BDA0A61BA7D4AD8F888"), 87)));
